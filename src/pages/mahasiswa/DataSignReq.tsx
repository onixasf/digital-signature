...
const DataSignatureRequestPage: React.FC = () => {
    ...
    const isDeletable = status === "Waiting to be sign";
    const buttonLabel = isDeletable ? "Delete" : "Unduh";

    const handleButtonClick = () => {
        if (isDeletable) {
            alert(`${buttonLabel} action performed for the file.`);
        } else {
            navigate("/pdf-viewer");
        }
    };
...
export default DataSignatureRequestPage;